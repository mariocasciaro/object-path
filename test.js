...
var expect = require('chai').expect,
  ...
  tests = ['instance', 'exported functions']
  ;
...
for(var i = 0; i < tests.length; i++) {
  ...
  (function(type){
    ...
    describe('objectPath ' + tests[i], function () {
      var objectPath;

      beforeEach(function(){
        objectPath = type === 'instance' ? ObjectPath.instance : ObjectPath;
      });
      ...
      describe('extend', function () {
        ...
        beforeEach(function(){
          objectPath = new ObjectPath.Class();
        });
...
describe('objectPath Class', function () {
  ...
  describe('class', function () {
    ...
    it('can accept new options', function () {
      ...
      expect(objpath.options).to.not.deep.equal(ObjectPath.defaultOptions);
    });
    ...
    it('can be extended as the main instance', function () {
      ...
      objpath.extend(function (x1, options) {
        (new ObjectPath.Class()).extend(function (x2) {
...
describe('objectPath exported helper functions', function () {
